...
btnEditTag.setAttribute("class","btn btn-secondary float-right m-r5 btn-sty ");
...
btnDeleteTag.setAttribute("class","btn btn-danger float-right btn-sty ");
...
{ 
    ...
    liEdit.childNodes[0].firstChild.firstChild.innerText="8/1/2017";    //dateTime.toLocaleDateString();
